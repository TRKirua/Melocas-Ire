...
public class BonusOtema : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (HadAttack)
        {
            if (WaitTimeAttack < 0)
            {
                ...
                {
                    Player[i].GetComponent<Attack1Otema>().BasicAttack -= 2;
                    
                    GameObject magikprojekt = Player[i].GetComponent<Attack2Otema>().magicProjectile;
                    int MagicAttack = magikprojekt.GetComponent<ProjectileOtema>().MagicAttack;
                    MagicAttack -= 2;
                    Player[i].GetComponent<Attack2Otema>().magicProjectile.GetComponent<ProjectileOtema>().MagicAttack = MagicAttack;
                }
            ...
            else
            {
                if (HadSpeed)
                {
                    if (ColorUtility.TryParseHtmlString("#F400FF", out newcolor))
        ...
        if (HadSpeed)
        {
            ...
            else
            {
                ...
                {
                    if (ColorUtility.TryParseHtmlString("#00A5FF", out newcolor))
                        renderer.material.color = newcolor;
                }
