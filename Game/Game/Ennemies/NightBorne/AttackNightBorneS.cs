...
public class AttackNightBorneS : MonoBehaviour
{
    ...
    {
        if (GetComponent<MobNightBorneS>().alreadyattacked && !GetComponent<MobNightBorneS>().isDead)
        {
        ...
        {
            GetComponent<MobNightBorneS>().NextAttack = 0;
        }
        
        GetComponent<MobNightBorneS>().isAttacking = false;
    }
